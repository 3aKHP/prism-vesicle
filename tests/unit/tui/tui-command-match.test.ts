...
const commands: Command[] = [
  { name: "model", completion: null, busyBehavior: { kind: "queue", boundary: "agent-loop" }, description: "switch the model", run: async () => {} },
  { name: "engine", completion: null, aliases: ["profile"], busyBehavior: { kind: "queue", boundary: "agent-loop" }, description: "switch the engine", run: async () => {} },
  { name: "effort", completion: null, busyBehavior: { kind: "queue", boundary: "agent-loop" }, description: "set provider thinking effort", run: async () => {} },
];
