...
It also registers the `vesicle` command and an Explorer **Open in Prism Vesicle** action for directories. Open a new terminal after installation before testing the command.
