...
你将使用 Vesicle Doctor 查看已保存配置，从开始菜单启动所选项目，并安全退出终端界面。
...
从开始菜单打开 **Prism Vesicle**。程序会进入 Setup 保存的项目目录。如果尚未配置项目，则会自动打开引导式 Setup。
...
再次从开始菜单打开 **Prism Vesicle**。它应当回到同一个已配置项目。请保持程序开启，以便继续下一章。
