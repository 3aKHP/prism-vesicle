...
> **状态标注约定**:每篇开头标 🟢 已实现 / 🟡 实验性,反映 `1.0.0-rc.1` 的成熟度。实验性特性会随版本转稳——**以 [`STATUS.md`](../../../../STATUS.md) 为权威的当前状态**,本区的标记可能滞后于代码。特性转稳时,改本页的状态表与对应页的开头一行即可。
...
| [MCP 工具](./mcp.md) | 🟢 MCP 工具 · 🟢 输出落盘 | 接入外部工具:连接配置、工具权限、可选结果存档 |
