...
| Output Quality Guard | Target-aware deterministic findings + document metric observe signals + durable Runtime decisions | Implemented on development branch |
