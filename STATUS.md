...
| Output Quality Guard | Target-aware deterministic findings + document metrics + opt-in experimental Runtime Semantic Judge + Semantic Rewrite Policy contract loader + durable decisions + developer benchmark runner | Implemented on development branch |
