...
| Output Quality Guard | Target-aware deterministic findings + document metrics + Runtime Semantic Judge observe + durable decisions + developer benchmark runner | Implemented on development branch |
