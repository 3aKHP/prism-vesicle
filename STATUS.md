...
| Output Quality Guard | Target-aware deterministic findings + document metrics + Runtime Semantic Judge observe + durable decisions | Implemented on development branch |
