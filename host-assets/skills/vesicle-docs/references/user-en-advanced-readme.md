...
> **Status convention:** each page opens with 🟢 Implemented / 🟡 Experimental, reflecting maturity in `1.0.0-beta.2`. Experimental features may stabilize over releases — **[`STATUS.md`](../../../../STATUS.md) is the authoritative current state**; the markers here may lag. When a feature graduates, update the table on this page and the status line on its page.
