<!-- Generated from docs/examples/providers.yaml — do not edit. -->
    ...
    models:
      ...
      - id: deepseek-v4-pro
        capabilities:
          ...
          maxTokens: true
          remoteCompact: false
          # Same built-in web search support as the flash entry above.
          builtinWebSearch: true
        webSearchDefault: false
