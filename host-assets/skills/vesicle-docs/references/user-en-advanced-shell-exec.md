<!-- Generated from docs/user/en/advanced/shell-exec.md — do not edit. -->

# Host shell and Process Runtime

English | [简体中文](../../zh-CN/advanced/shell-exec.md)

> **Status (as of `1.0.0-alpha.10`):** 🟢 Implemented. This is a **non-sandboxed** capability with host-user authority, off by default. Maturity per [`STATUS.md`](../../../../STATUS.md).
>
