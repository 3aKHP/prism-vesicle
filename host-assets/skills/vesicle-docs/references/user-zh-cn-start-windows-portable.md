<!-- Generated from docs/user/zh-CN/start/windows-portable.md — do not edit. -->
...
> Beta 阶段的 Windows 工件有意未做 Authenticode 签名(签名已推迟)。校验和能确认文件未被篡改,但不等于签名。详见[参考:校验和与签名](../reference/checksums-and-signing.md)。
