<!-- Generated from docs/user/zh-CN/reference/checksums-and-signing.md — do not edit. -->
...
**当前状态(`1.0.0-alpha.10`)**:Windows 可执行文件与安装器**有意未签名**。Windows 签名推迟到项目具备引入签名服务的条件后再考虑,不设版本截止期限。因此:
