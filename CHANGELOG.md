...
- Refreshed the complete bundled V10 baseline to exact Neural Narratology Release `harness-20260716-1` / `prism-engine-v10@10.0.1-alpha.2` from commit `ce3d1f1e8b1738b3d5f19e1913298ac9756b8a36`. The package, standalone payload, and rollback baseline now carry the 54-file manifest inventory and Anti-AI-Flavor Rule Pack `0.3.0-alpha.1`.
