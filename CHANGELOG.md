...
- Refreshed the complete bundled V10 baseline to exact Neural Narratology Release `harness-20260716-2` / `prism-engine-v10@10.0.1-alpha.3` from commit `b975e1893d2b463f039605b4abb72f18c8f385bd`. The package, standalone payload, and rollback baseline carry the exact 54-file manifest inventory and Anti-AI-Flavor Rule Pack `0.3.0-alpha.2`.
