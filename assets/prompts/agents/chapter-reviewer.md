...
3. Scene Rhythm、张力与声明内容覆盖（Key Events / 改造指令）
   ...
   - 改造指令落地：如本章声明了 Transformation Directive，逐条审计每个声明改造点是否在正文实际落地；只在字面提及而未在动机层、关系层或结构层兑现的判为未落地
4. 角色时空、Props、伏笔和 World Facts 连续性
   ...
   - 物理描述正典一致性：已出场角色的不可变物理特征（瞳色、发色、身高、胎记等，见角色卡 `## Visual Cortex`）在章内前后一致、与角色卡不矛盾
